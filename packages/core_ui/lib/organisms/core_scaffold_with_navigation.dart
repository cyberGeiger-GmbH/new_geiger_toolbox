...
/// return this widget in the builder property in StatefulShellRoute
class CoreScaffoldWithNavigation extends StatelessWidget {
  const CoreScaffoldWithNavigation({super.key, required this.navigationShell});
