...
/// @nodoc
mixin _$AppSpacing {
  double get xsmall => throw _privateConstructorUsedError;
...
class _$AppSpacingImpl extends _AppSpacing {
  ...
  @override
  String toString() {
    return 'AppSpacing(xsmall: $xsmall, small: $small, medium: $medium, big: $big, large: $large)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$AppSpacingImpl &&
            (identical(other.xsmall, xsmall) || other.xsmall == xsmall) &&
  ...
  _$$AppSpacingImplCopyWith<_$AppSpacingImpl> get copyWith =>
      __$$AppSpacingImplCopyWithImpl<_$AppSpacingImpl>(this, _$identity);
}
...
abstract class $AppEdgeInsetsSpacingCopyWith<$Res> {
  ...
  $AppSpacingCopyWith<$Res> get spacing;
}
...
class _$AppEdgeInsetsSpacingCopyWithImpl<$Res, $Val extends AppEdgeInsetsSpacing>
  ...
  @pragma('vm:prefer-inline')
  $AppSpacingCopyWith<$Res> get spacing {
    return $AppSpacingCopyWith<$Res>(_value.spacing, (value) {
...
class _$AppEdgeInsetsSpacingImpl extends _AppEdgeInsetsSpacing {
  const _$AppEdgeInsetsSpacingImpl({required this.spacing}) : super._();
  ...
  @override
  String toString() {
    return 'AppEdgeInsetsSpacing(spacing: $spacing)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$AppEdgeInsetsSpacingImpl &&
