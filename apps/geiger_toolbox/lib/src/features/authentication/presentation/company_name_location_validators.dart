...
mixin CompanyNameLocationValidators {
  final StringValidator companyNameNonEmptyValidator =
      NonEmptyStringValidator();
  final StringValidator companyNameMinValueValidator =
  ...
  bool canSubmitCompanyName(String name) {
    return companyNameNonEmptyValidator.isValid(name) &&
        companyNameMinValueValidator.isValid(name);
  }
  ...
  String? companyNameErrorText(String name) {
    ...
    final String errrorText = name.isEmpty
        ? "Company name can't be empty".hardcoded
        : "Company name too short".hardcoded;
